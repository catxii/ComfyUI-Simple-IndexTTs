...
class IndexTTS2:
    def __init__(
            ...
            use_cuda_kernel=None, use_deepspeed=False, local_files_only=False,
    ):
        """
        Args:
    ...
    def infer_generator(self, spk_audio_prompt, text, output_path,
        ...
        if self.cache_spk_cond is None or is_tensor_equal(self.cache_spk_audio_prompt, spk_audio_prompt):
            ...
            audio, sr = self._load_and_cut_audio(spk_audio_prompt, 15, verbose, sr=22050)
        ...
        diffusion_steps = max(4, min(25, diffusion_steps))
        sampling_rate = 22050
        ...
        for seg_idx, sent in enumerate(segments):
            ...
            with torch.no_grad():
                ...
                with torch.amp.autocast(text_tokens.device.type, enabled=dtype is not None, dtype=dtype):
                    ...
                    # Keep full-quality decoding by default; callers can lower this for previews.
